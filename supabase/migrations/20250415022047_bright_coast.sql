/*
  # Fix Core WAF Templates

  1. Changes
    - Reinsert all core templates with correct ordering
    - Ensure all required fields are populated
    - Maintain version history capability
...
-- First, remove existing core templates to prevent duplicates
DELETE FROM waf_templates WHERE is_core = true;

-- Insert core templates with correct ordering
INSERT INTO waf_templates (
  name,
  description,
  expression,
  action,
